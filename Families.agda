...
-- Representability of the morphism Tm → Ty (meaning that ∫ Tm → ∫ Ty has a right adjoint, i.e. context extension) can be captured internally using a crisp extension of type theory.
